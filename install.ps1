<#
	.SYNOPSIS
		Installs the d365fo.integrations Module from github
		
	.DESCRIPTION
		This script installs the d365fo.integrations Module from github.
