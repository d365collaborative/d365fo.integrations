...
Remove-Module d365fo.integrations -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\d365fo.integrations.psd1"
Import-Module "$PSScriptRoot\..\d365fo.integrations.psm1" -Force
