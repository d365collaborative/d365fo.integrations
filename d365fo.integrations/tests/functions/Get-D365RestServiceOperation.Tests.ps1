Describe "Get-D365RestServiceOperation Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-D365RestServiceOperation).ParameterSets.Name | Should -Be 'Default'
		}
		
		It 'Should have the expected parameter ServiceGroupName' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['ServiceGroupName']
			$parameter.Name | Should -Be 'ServiceGroupName'
		...
		It 'Should have the expected parameter ServiceName' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['ServiceName']
			$parameter.Name | Should -Be 'ServiceName'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter OperationName' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['OperationName']
			$parameter.Name | Should -Be 'OperationName'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['Url']
		...
		It 'Should have the expected parameter SystemUrl' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['SystemUrl']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['Token']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['EnableException']
		...
		It 'Should have the expected parameter RawOutput' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['RawOutput']
		...
		It 'Should have the expected parameter OutputAsJson' {
			$parameter = (Get-Command Get-D365RestServiceOperation).Parameters['OutputAsJson']
	...
	Describe "Testing parameterset Default" {
		<#
		Default -ServiceGroupName -ServiceName
		Default -ServiceGroupName -ServiceName -OperationName -Tenant -Url -SystemUrl -ClientId -ClientSecret -Token -EnableException -RawOutput -OutputAsJson
		#>
	}
