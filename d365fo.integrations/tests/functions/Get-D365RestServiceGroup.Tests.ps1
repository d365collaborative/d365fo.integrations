Describe "Get-D365RestServiceGroup Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-D365RestServiceGroup).ParameterSets.Name | Should -Be 'Default'
		}
		
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['Name']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['Url']
		...
		It 'Should have the expected parameter SystemUrl' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['SystemUrl']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter RawOutput' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['RawOutput']
		...
		It 'Should have the expected parameter OutputAsJson' {
			$parameter = (Get-Command Get-D365RestServiceGroup).Parameters['OutputAsJson']
