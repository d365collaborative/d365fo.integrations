Describe "Import-D365ODataEntity Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Import-D365ODataEntity).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EntityName' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['EntityName']
		...
		It 'Should have the expected parameter Payload' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['Payload']
		...
		It 'Should have the expected parameter PayloadCharset' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['PayloadCharset']
		...
		It 'Should have the expected parameter CrossCompany' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['CrossCompany']
		...
		It 'Should have the expected parameter RetryTimeout' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['RetryTimeout']
		...
		It 'Should have the expected parameter ThrottleSeed' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['ThrottleSeed']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['Url']
		...
		It 'Should have the expected parameter SystemUrl' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['SystemUrl']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['Token']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Import-D365ODataEntity).Parameters['EnableException']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EntityName -Payload -PayloadCharset -CrossCompany -RetryTimeout -ThrottleSeed -Tenant -Url -SystemUrl -ClientId -ClientSecret -Token -EnableException
		#>
	}
