Describe "Get-D365RestService Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-D365RestService).ParameterSets.Name | Should -Be 'Default'
		}
		
		It 'Should have the expected parameter ServiceGroupName' {
			$parameter = (Get-Command Get-D365RestService).Parameters['ServiceGroupName']
		...
		It 'Should have the expected parameter ServiceName' {
			$parameter = (Get-Command Get-D365RestService).Parameters['ServiceName']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Get-D365RestService).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Get-D365RestService).Parameters['Url']
		...
		It 'Should have the expected parameter SystemUrl' {
			$parameter = (Get-Command Get-D365RestService).Parameters['SystemUrl']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Get-D365RestService).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Get-D365RestService).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-D365RestService).Parameters['Token']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Get-D365RestService).Parameters['EnableException']
		...
		It 'Should have the expected parameter RawOutput' {
			$parameter = (Get-Command Get-D365RestService).Parameters['RawOutput']
		...
		It 'Should have the expected parameter OutputAsJson' {
			$parameter = (Get-Command Get-D365RestService).Parameters['OutputAsJson']
	...
	Describe "Testing parameterset Default" {
		<#
		Default -ServiceGroupName
		Default -ServiceGroupName -ServiceName -Tenant -Url -SystemUrl -ClientId -ClientSecret -Token -EnableException -RawOutput -OutputAsJson
		#>
	}
