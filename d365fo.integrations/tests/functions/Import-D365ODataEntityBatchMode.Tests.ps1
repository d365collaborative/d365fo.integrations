Describe "Import-D365ODataEntityBatchMode Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ThrottleSeed' {
			$parameter = (Get-Command Import-D365ODataEntityBatchMode).Parameters['ThrottleSeed']
		...
		It 'Should have the expected parameter SystemUrl' {
			$parameter = (Get-Command Import-D365ODataEntityBatchMode).Parameters['SystemUrl']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Import-D365ODataEntityBatchMode).Parameters['Token']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EntityName -Payload -CrossCompany -ThrottleSeed -Tenant -Url -SystemUrl -ClientId -ClientSecret -RawOutput -Token -EnableException
		#>
	}
