Describe "Import-D365DmfPackage Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Import-D365DmfPackage).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Path' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['Path']
		...
		It 'Should have the expected parameter JobId' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['JobId']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['Url']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Import-D365DmfPackage).Parameters['EnableException']
