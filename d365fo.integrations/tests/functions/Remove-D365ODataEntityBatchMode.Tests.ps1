Describe "Remove-D365ODataEntityBatchMode Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-D365ODataEntityBatchMode).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter EntityName' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['EntityName']
		...
		It 'Should have the expected parameter Key' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['Key']
		...
		It 'Should have the expected parameter CrossCompany' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['CrossCompany']
		...
		It 'Should have the expected parameter ThrottleSeed' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['ThrottleSeed']
		...
		It 'Should have the expected parameter Tenant' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['Tenant']
		...
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['Url']
		...
		It 'Should have the expected parameter SystemUrl' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['SystemUrl']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter RawOutput' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['RawOutput']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['Token']
		...
		It 'Should have the expected parameter EnableException' {
			$parameter = (Get-Command Remove-D365ODataEntityBatchMode).Parameters['EnableException']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -EntityName -Key -CrossCompany -ThrottleSeed -Tenant -Url -SystemUrl -ClientId -ClientSecret -RawOutput -Token -EnableException
		#>
	}
